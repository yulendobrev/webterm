...
namespace ErlangVMA
{
	...
	{
		private static IVmBroker vmBroker;
		private static Dictionary<VmUser, dynamic> clientsDict;

		static VirtualMachineHub()
		{
			clientsDict = new Dictionary<VmUser, dynamic>();
			vmBroker = VmBroker.Instance;
			vmBroker.ScreenUpdated += (user, nodeAddress, screenData) =>
			{
