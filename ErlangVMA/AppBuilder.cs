...
namespace Owin.Builder
{
    ...
    internal class AppBuilder : IAppBuilder
    {
        ...
        public AppBuilder()
        {
            ...
            _properties["owin.BuilderAddConversion"] = new Action<Delegate>(AddSignatureConversion);
            _properties["owin.BuilderDefaultApp"] = NotFound;
        }
        ...
        {
            object app;
            if (!_properties.TryGetValue("owin.BuilderDefaultApp", out app))
            {
                app = NotFound;
            }
        ...
        private object Convert(Type signature, object app)
        {
            ...
            throw new ArgumentException(
				string.Format(CultureInfo.CurrentCulture, "No conversion from {0} to {1} exists", app.GetType(), signature), 
                "signature");
        }
        ...
        private static Tuple<Type, Delegate, object[]> ToMiddlewareFactory(object middlewareObject, object[] args)
        {
            ...
            throw new NotSupportedException("Middleware not supported" + (middlewareObject ?? string.Empty).ToString());
        }
        ...
        private static Tuple<Type, Delegate, object[]> ToConstructorMiddlewareFactory(object middlewareObject, object[] args, ref Delegate middlewareDelegate)
        {
            ...
            throw new MissingMethodException(middlewareType.FullName,
                string.Format(CultureInfo.CurrentCulture, "No constructor taking {0} parameters found", args.Length + 1));
        }
